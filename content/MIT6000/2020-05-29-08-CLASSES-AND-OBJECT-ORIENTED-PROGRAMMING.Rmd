...
Yes. While this relatively weak static semantic checking is a flaw in Python, it is
...
1. People could get lower interest rates by paying “points” to the lender at the time they took on the mortgage. A point is a cash payment of 1% of the value of the loan. 
...
class FixedWithPts (Mortgage):
    ...
    def __init__(self, loan, r, months, pts):
        ...
        self.paid = [loan*(pts/100)] # Override Mortgage's init 0.0. Note that this fee cannot be used to reduce the outstanding of loan balance.
        self.legend = 'Fixed, ' + str (round (r*100, 2)) + '%, '\
                      + str (pts) + ' points'
...
class TwoRate (Mortgage):
    ...
    def makePayment (self):
        # When time is up, replace teaser rate with next rate, and then calculate monthly payment again with new loan, new rate and new months.
