...
class Digraph(object):
    """
    Directional graph, with a list of nodes, and edges as a dictionary of
    {parent:[children]} pairs.
    """
    def __init__(self):
        """
        Initiate an instance of digraph with its nodes as empty list, and its edges as empty dictionary.
        """
        self.nodes = []
        self.edges = {}
    ...
    def add_node(self, node):
        ...
        :param node: node, as part of an edge.
        :return: none.
        """
    ...
    def add_edge (self, edge):
        ...
        :return: none, append the destination to the list of edges[source].
        """
...
class Graph (Digraph):
    ...
    def add_edge (self, edge):
        """
        Add edge with no direction between two nodes.
        :param edge: an edge with source and destination nodes.
        :return: none, append the destination to the list of edges[source].
        """
